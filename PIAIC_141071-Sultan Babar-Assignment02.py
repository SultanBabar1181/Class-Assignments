...
def function5():
    ...
    z = np.zeros((20), dtype= int).reshape((4,5))
...
def function7():
    ...
    return np.zeros((4),dtype= np.int64) #wrtie your code here
...
def function10():
    ...
    brr = np.array([1,2,3])
    subt = np.subtract(brr,arr) #wrtie your code here
...
def function11():
    ...
    arr[1::2] = -1 #wrtie your code here
...
def function13():
    ...
    ans = arr[(arr>5) & (arr<10)] #wrtie your code here
...
def function15():
    ...
    ans = np.sort(arr, axis= 0) #wrtie your code here
...
def function18():
    ...
    x = students[students<100]   # Write you code Here
    return x.size
